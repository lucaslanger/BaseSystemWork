...
%effect of exponent in Base M-PSR
...
%Results for Coloured Double loops 27-17, in low data regime (left), high data regime (middle) and as a function of different numbers of operators (right)
\end{figure*}
