...
\begin{figure*}[ht!]
\centering
\includegraphics[width=45mm]{uCOREPICS/DL/64-16-100.png}\includegraphics[width=45mm]{uCOREPICS/DL/64-16-10000.png}\includegraphics[width=45mm]{uCOREPICS/DL/NoiseInfo.png}\includegraphics[width=45mm]{uCOREPICS/DL/basePows.png}\vspace*{-4mm}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=35mm]{uCOREPICS/DL/doubleLoopImage.png}
%\caption{Double Loop Environment\label{overflow}}
%\end{figure}
%
%\begin{figure}[ht!]
%\centering
\includegraphics[width=40mm,height=50mm]{uCOREPICS/Pacman/graphPacMan.png}\vspace*{-4mm}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=40mm]{uCOREPICS/DL/47-27-10000.png}\vspace*{-4mm}
...
%\begin{figure}[ht!]
%\centering
\includegraphics[width=42mm]{uCOREPICS/Pacman/Pacman500.png}
%\caption{Low Data Pacman Labyrinth\label{fig-paclow}}
%\end{figure}
%
%
%\centering
\includegraphics[width=42mm]{uCOREPICS/Pacman/Pacman10k.png}
...
%\begin{figure}[ht!]
%\centering
\includegraphics[width=42mm]{uCOREPICS/Pacman/PacmanSF=1.png}
%\caption{Stretch Factor: 1\label{fig-pacsf1}}
%\end{figure}
%
%\begin{figure}[ht!]
%\centering
\includegraphics[width=42mm]{uCOREPICS/Pacman/PacmanSF=5.png}\vspace*{-4mm}
...
\begin{figure*}[t!]
\centering
\includegraphics[width=42mm]{uCOREPICS/DLMO/MO_50.png}
%\caption{Low Data Colored Loops 27-17\label{fig-collow}}
%\end{figure}
%
%\begin{figure}[ht!]
%\centering
\includegraphics[width=42mm]{uCOREPICS/DLMO/MO_1k.png}
...
%\begin{figure}[ht!]
%\centering
\includegraphics[width=42mm]{uCOREPICS/DLMO/numOpComparison.png}\vspace*{-4mm}
